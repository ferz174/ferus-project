...
<xsl:stylesheet version ="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"	xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xalan="http://xml.apache.org/xalan" xmlns:counter="bitel.billing.server.util.exslt.Counter" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:js="javascript:code">
<xsl:decimal-format name="weight"/>
	<xsl:template match="Заказ">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:js="javascript:code">
							...
							<fo:table-row height="5mm">
								...
								<fo:table-cell display-align="center" border-width="0.5mm" border-style="solid" number-rows-spanned="2" number-columns-spanned="4" border-right-width="0.25mm">
									<fo:block font-family="gost_bi" font-style="italic" font-size="18pt" text-align="center">
										<xsl:value-of select="normalize-space(@Номер)"/>-<xsl:value-of select="normalize-space(Документ/@Раздел)"/>-<xsl:value-of select="normalize-space(Документ/@Документ)"/>.<fo:page-number/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row height="5mm">
					...
					<fo:table>
						...
						<fo:table-body>
							...
							<fo:table-row height="5mm">
								...
								<fo:table-cell display-align="center" border-width="0.25mm" border-style="solid" number-rows-spanned="3"  border-top-width="0.5mm" border-right-width="0.5mm">
									<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="center" start-indent="1mm">
										<xsl:value-of select="Документ/@Название"/> <xsl:value-of select="Документ/@Раздел"/>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell display-align="center" border-width="0.25mm" border-style="solid" number-rows-spanned="3" number-columns-spanned="3">
									<fo:block font-family="gost_bi" font-style="italic" font-size="7pt" text-align="center">
					...
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row height="14mm">
								<fo:table-cell display-align="center" border-style="solid" number-columns-spanned="5" border-width="0.5mm" border-left-width="0.25mm" border-right-width="0.25mm">
						...
						<fo:table-body>
							<xsl:for-each select="Приоритет">
								<xsl:for-each select="Чертеж">
									...
									<fo:table-cell display-align="center" border-width="0.25mm" border-style="solid" border-right-width="0.5mm">
										<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="left" start-indent="2mm">
