		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			<fo:layout-master-set>
				<fo:simple-page-master master-name="page_1" page-height="297mm" page-width="210mm" margin-top="5mm" margin-bottom="5mm" margin-left="20mm" margin-right="5mm">
					...
					<fo:region-before region-name="notes" extent="30mm"/>
					<fo:region-body margin-top="32mm" margin-bottom="55mm" margin-left="0mm" margin-right="5mm"/>
					...
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row height="5mm">
								...
								<fo:table-cell display-align="center" border-width="0.5mm" border-style="solid" number-rows-spanned="2" number-columns-spanned="4" border-right-width="0.25mm">
									<fo:block font-family="gost_bi" font-style="italic" font-size="18pt" text-align="center">
										<xsl:value-of select="normalize-space(@Номер)"/>-<xsl:value-of select="normalize-space(Документ/@Раздел)"/>-<xsl:value-of select="normalize-space(Документ/@Шифр)"/>.<fo:page-number/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row height="5mm">
							...
							<fo:table-row height="5mm">
								...
								<fo:table-cell display-align="center" border-width="0.5mm" border-style="solid" border-bottom-width="0.25mm">
								</fo:table-cell>
								<fo:table-cell display-align="center" border-width="0.25mm" border-style="solid">
								</fo:table-cell>
							...
							<fo:table-row height="5mm">
								...
								<fo:table-cell display-align="center" border-width="0.5mm" border-style="solid" number-rows-spanned="2" >
									<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="center" start-indent="1mm">
										<xsl:value-of select="normalize-space(Документ/@Шифр)"/>.<fo:page-number/>
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="5mm">
								...
								<fo:table-cell display-align="center" border-width="0.25mm" border-style="solid" number-rows-spanned="3"  border-top-width="0.5mm" border-right-width="0.5mm">
									<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="center" start-indent="1mm">
										<xsl:value-of select="Документ/@Название"/><!--Общие данные (начало)-->
									</fo:block>
								</fo:table-cell>
					...
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row height="5mm">
								...
								<fo:table-cell display-align="center" border-width="0.5mm" border-style="solid" number-rows-spanned="3" number-columns-spanned="4" border-right-width="0.25mm">
									<fo:block font-family="gost_bi" font-style="italic" font-size="18pt" text-align="center">
										<xsl:value-of select="normalize-space(@Номер)"/>-<xsl:value-of select="normalize-space(Документ/@Раздел)"/>-<xsl:value-of select="normalize-space(Документ/@Номер)"/>-<fo:page-number/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row height="5mm">
					...
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row height="14mm">
								<fo:table-cell display-align="center" number-columns-spanned="8" border-style="solid" border-width="0.5mm" border-left-width="0.25mm" border-right-width="0.25mm">
							...
							<fo:table-row height="18mm">
								...
								<fo:table-cell display-align="center" border-width="0.5mm" border-style="solid" border-top-width="0.25mm">
									<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="center" start-indent="1.5mm">
										Длина, мм
									</fo:block>
								</fo:table-cell>-->
								<fo:table-cell display-align="center" border-width="0.5mm" border-style="solid" border-top-width="0.25mm">
								...
								<fo:table-cell display-align="center" border-width="0.5mm" border-style="solid" border-top-width="0.25mm">
									<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="center" space-before="0.5mm">
								...
								<xsl:for-each select="Саморез">
									<fo:table-row height="8mm">
										<fo:table-cell border-width="0.25mm" border-style="solid" border-right-width="0.5mm">
											<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="left" start-indent="1mm" space-before="2.6mm">
												<xsl:value-of select="@Обозначение"/>
											</fo:block>
										</fo:table-cell>
										<!--<fo:table-cell border-width="0.25mm" border-style="solid" border-right-width="0.5mm">
											<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="right" space-before="2.6mm">
												<xsl:value-of select="Мин/@ТолщПакета"/> - <xsl:value-of select="Макс/@ТолщПакета"/>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell border-width="0.25mm" border-style="solid" border-right-width="0.5mm">
											<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="right" end-indent="2mm" space-before="2.6mm">
												<xsl:value-of select="@Длина"/>
											</fo:block>
										</fo:table-cell>-->
										<fo:table-cell border-width="0.25mm" border-style="solid" border-right-width="0.5mm">
											<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="right" end-indent="2mm" space-before="2.6mm">
												<xsl:value-of select="format-number(@Количество*1.1, '##0')"/>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell border-width="0.25mm" border-style="solid" border-right-width="0.5mm">
											<fo:block font-family="gost_bi" font-style="italic" font-size="12pt" text-align="right" end-indent="2mm" space-before="2.6mm">
												<xsl:value-of select="format-number(@Вес*0.0011, '##0.#')"/>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell border-width="0.25mm" border-style="solid" border-right-width="0.5mm">
											<fo:block font-family="gost_bi" font-style="italic" font-size="10pt" text-align="left" start-indent="1mm" space-before="2.6mm">
